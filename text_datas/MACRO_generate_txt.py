...
# function_numbers = [1, 10, 100, 1000, 10000]
function_numbers = [1]
computation_factors = [1, 10, 100, 1000, 10000, 100000, 1000000, 10000000]

# Path to the generate_txt_files.py script
script_path = "/Users/takehikazuki/Desktop/todai/first_project/text_datas/generate_txt_files.py"
...
for num_funcs in function_numbers:
    for factor in computation_factors:
        ...
        filename = f"check_for_{num_funcs}_funcs_{loop_count}_loops.txt"
